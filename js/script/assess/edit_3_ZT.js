        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                if(numStr.indexOf(inNum)!=-1 && list.assIndexCateCd != '03'){
                    ...
                    if(list.assIndexCateCd != '03'){
                    	if(indexLine=='01'){
                    		//公司线
                    		editableTableSetValue(tableIdQ,indexQ,"neguIndexWeiLS",null,"disable");
                    		editableTableSetShowValue(tableIdQ,indexQ,"neguIndexWeiLS","--");
                    		editableTableSetValue(tableIdQ,indexQ,"neguIndexWeiSC",null,"disable");
                    		editableTableSetShowValue(tableIdQ,indexQ,"neguIndexWeiSC","--");
                    		editableTableSetValue(tableIdQ,indexQ,"whfIndexWeiLS",null,"disable");
                    		editableTableSetShowValue(tableIdQ,indexQ,"whfIndexWeiLS","--");
                    		editableTableSetValue(tableIdQ,indexQ,"whfIndexWeiSC",null,"disable");
                    		editableTableSetShowValue(tableIdQ,indexQ,"whfIndexWeiSC","--");
                    		
                    	}else if(indexLine=='02'){
                    		//零售线
                    		editableTableSetValue(tableIdQ,indexQ,"neguIndexWeiGS",null,"disable");
                    		editableTableSetShowValue(tableIdQ,indexQ,"neguIndexWeiGS","--");
                    		editableTableSetValue(tableIdQ,indexQ,"neguIndexWeiSC",null,"disable");
                    		editableTableSetShowValue(tableIdQ,indexQ,"neguIndexWeiSC","--");
                    		editableTableSetValue(tableIdQ,indexQ,"whfIndexWeiGS",null,"disable");
                    		editableTableSetShowValue(tableIdQ,indexQ,"whfIndexWeiGS","--");
                    		editableTableSetValue(tableIdQ,indexQ,"whfIndexWeiSC",null,"disable");
                    		editableTableSetShowValue(tableIdQ,indexQ,"whfIndexWeiSC","--");
                    		
                    	}else if(indexLine=='03'){
                    		//市场线
                    		editableTableSetValue(tableIdQ,indexQ,"neguIndexWeiLS",null,"disable");
                    		editableTableSetShowValue(tableIdQ,indexQ,"neguIndexWeiLS","--");
                    		editableTableSetValue(tableIdQ,indexQ,"whfIndexWeiLS",null,"disable");
                    ...
                    if(tableIdQ == 'datatable_m' && list.assIndexCateCd == '03'){
                        ...
                        $("#"+tableIdQ +" tr[data-index = '" +indexQ+"'] a[data-name = 'neguIndexWeiZT']").editable('toggleDisabled',false);
                        $("#"+tableIdQ+">tbody").find("tr").eq(indexQ).find("td").eq(10).find("a").text("--");
                        $("#"+tableIdQ +" tr[data-index = '" +indexQ+"'] a[data-name = 'neguIndexWeiGS']").editable('toggleDisabled',false);
                        $("#"+tableIdQ+">tbody").find("tr").eq(indexQ).find("td").eq(11).find("a").text("--");
                        $("#"+tableIdQ +" tr[data-index = '" +indexQ+"'] a[data-name = 'neguIndexWeiLS']").editable('toggleDisabled',false);
                        $("#"+tableIdQ+">tbody").find("tr").eq(indexQ).find("td").eq(12).find("a").text("--");
                        $("#"+tableIdQ +" tr[data-index = '" +indexQ+"'] a[data-name = 'neguIndexWeiSC']").editable('toggleDisabled',false);
                        $("#"+tableIdQ+">tbody").find("tr").eq(indexQ).find("td").eq(13).find("a").text("--");
                        $("#"+tableIdQ +" tr[data-index = '" +indexQ+"'] a[data-name = 'whfIndexWeiZT']").editable('toggleDisabled',false);
                        $("#"+tableIdQ+">tbody").find("tr").eq(indexQ).find("td").eq(15).find("a").text("--");
                        $("#"+tableIdQ +" tr[data-index = '" +indexQ+"'] a[data-name = 'whfIndexWeiGS']").editable('toggleDisabled',false);
                        $("#"+tableIdQ+">tbody").find("tr").eq(indexQ).find("td").eq(16).find("a").text("--");
                        $("#"+tableIdQ +" tr[data-index = '" +indexQ+"'] a[data-name = 'whfIndexWeiLS']").editable('toggleDisabled',false);
                        $("#"+tableIdQ+">tbody").find("tr").eq(indexQ).find("td").eq(17).find("a").text("--");
                        $("#"+tableIdQ +" tr[data-index = '" +indexQ+"'] a[data-name = 'whfIndexWeiSC']").editable('toggleDisabled',false);
    ...
    $("#btn_save_m").click(function () {
        ...
        $.each(tableData, function (index, item) {
        	...
        	if(item.assIndexCateDesc!='定性指标'){
        		...
        		if(!checkProfessionTypeNegu(item)){
        			flag = true;
        			nextFlag = false;
        			// layer.msg(item.indexName+"的四个必保权重不能同时为空，后三个权重仅能有一个值",{icon:2});
        			return false;
        		}
        		if(!checkProfessionTypeWhf(item)){
        			flag = true;
        			nextFlag = false;
        			// layer.msg(item.indexName+"的四个力争权重不能同时为空，后三个权重仅能有一个值",{icon:2});
        			return false;
        		}
        		if(!checkProfessionTypeNeguAndWhf(item)){
        			flag = true;
        			nextFlag = false;
        			// layer.msg(item.indexName+",力争权重与必保权重必须填写相同的业务权重",{icon:2});
        			return false;
        		}
        	}
...
function prev() {
    window.location.href = portal.bp() + "/edit_2.json?assPropNum=" + assPropNum + "&operateType=" + operateType;
}
    ...
    },
    {
        ...
        editable: {
            ...
            validate:function(v){
            	...
            	var indexLine = $("#datatable_m").bootstrapTable("getData")[index].indexLine;
            	if(indexLine!=undefined&&indexLine!=null){
                	if(indexLine=='01'){
                		//公司线
                		editableTableSetValue("datatable_m",index,"neguIndexWeiLS",null,"disable");
                		editableTableSetShowValue("datatable_m",index,"neguIndexWeiLS","--");
                		editableTableSetValue("datatable_m",index,"neguIndexWeiSC",null,"disable");
                		editableTableSetShowValue("datatable_m",index,"neguIndexWeiSC","--");
                		editableTableSetValue("datatable_m",index,"whfIndexWeiLS",null,"disable");
                		editableTableSetShowValue("datatable_m",index,"whfIndexWeiLS","--");
                		editableTableSetValue("datatable_m",index,"whfIndexWeiSC",null,"disable");
                		editableTableSetShowValue("datatable_m",index,"whfIndexWeiSC","--");
                		
                	}else if(indexLine=='02'){
                		//零售线
                		editableTableSetValue("datatable_m",index,"neguIndexWeiGS",null,"disable");
                		editableTableSetShowValue("datatable_m",index,"neguIndexWeiGS","--");
                		editableTableSetValue("datatable_m",index,"neguIndexWeiSC",null,"disable");
                		editableTableSetShowValue("datatable_m",index,"neguIndexWeiSC","--");
                		editableTableSetValue("datatable_m",index,"whfIndexWeiGS",null,"disable");
                		editableTableSetShowValue("datatable_m",index,"whfIndexWeiGS","--");
                		editableTableSetValue("datatable_m",index,"whfIndexWeiSC",null,"disable");
                		editableTableSetShowValue("datatable_m",index,"whfIndexWeiSC","--");
            	...
            	if(v!=undefined&&v!=null&&v=='定性指标'){
                    ...
                    disableSiblingsAndSetValue($el,'neguIndexWeiZT','--');
                    disableSiblingsAndSetValue($el,'neguIndexWeiGS','--');
                    disableSiblingsAndSetValue($el,'neguIndexWeiLS','--');
                    disableSiblingsAndSetValue($el,'neguIndexWeiSC','--');
                    disableSiblingsAndSetValue($el,'whfIndexWeiZT','--');
                    disableSiblingsAndSetValue($el,'whfIndexWeiGS','--');
                    disableSiblingsAndSetValue($el,'whfIndexWeiLS','--');
                    disableSiblingsAndSetValue($el,'whfIndexWeiSC','--');
        ...
        editable: {
            ...
            validate: function (v) {
                ...
                if(val == '定性指标') {
                	...
                	if(v!=null&&v!=''){
                		if (isNaN(v)) {
                			return "整体业务必保权重必须是数字";
                		}
                		
                		
                		if (!pattern2.test(v)) {
                			return '整体业务必保权重必须是大于等于0小于等于100的整数';
                		}
    	...
    	editable: {
    		...
    		validate: function (v) {
    			...
    			if(val == '定性指标') {
    				...
    				if(v!=null&&v!=''){
    					if (isNaN(v)) {
    						return "公司业务必保权重必须是数字";
    					}
    					
    					
    					if (!pattern2.test(v)) {
    						return '公司业务必保权重必须是大于等于0小于等于100的整数';
    					}
    					var floatFormat = parseFloat(v);
    					if (floatFormat > 100 || floatFormat < 0) {
    						return '公司业务必保权重必须是大于等于0小于等于100的整数';
    	...
    	editable: {
    		...
    		validate: function (v) {
    			...
    			if(val == '定性指标') {
    				...
    				if(v!=null&&v!=''){
    					if (isNaN(v)) {
    						return "零售业务必保权重必须是数字";
    					}
    					
    					
    					if (!pattern2.test(v)) {
    						return '零售业务必保权重必须是大于等于0小于等于100的整数';
    					}
    					var floatFormat = parseFloat(v);
    					if (floatFormat > 100 || floatFormat < 0) {
    						return '零售业务必保权重必须是大于等于0小于等于100的整数';
    	...
    	editable: {
    		...
    		validate: function (v) {
    			...
    			if(val == '定性指标') {
    				...
    				if(v!=null&&v!=''){
	    				if (isNaN(v)) {
	    					return "市场业务必保权重必须是数字";
	    				}
    					
    					if (!pattern2.test(v)) {
    						return '市场业务必保权重必须是大于等于0小于等于100的整数';
    					}
    					var floatFormat = parseFloat(v);
    					if (floatFormat > 100 || floatFormat < 0) {
    						return '市场业务必保权重必须是大于等于0小于等于100的整数';
        ...
        editable: {
            ...
            validate: function (v) {
                ...
                if(val == '定性指标') {
                	...
                	if(v!=null&&v!=''){
                		if (isNaN(v)) {
                			return "整体业务力争权重必须是数字";
                		}
                		
                		
                		if (!pattern2.test(v)) {
                			return '整体业务力争权重必须是大于等于0小于等于100的整数';
                		}
                		var floatFormat = parseFloat(v);
                		if (floatFormat > 100 || floatFormat < 0) {
                			return '整体业务力争权重必须是大于等于0小于等于100的整数';
    	...
    	editable: {
    		...
    		validate: function (v) {
    			...
    			if(val == '定性指标') {
    				...
    				if(v!=null&&v!=''){
    					if (isNaN(v)) {
    						return "公司业务力争权重必须是数字";
    					}
    					
    					
    					if (!pattern2.test(v)) {
    						return '公司业务力争权重必须是大于等于0小于等于100的整数';
    					}
    					var floatFormat = parseFloat(v);
    					if (floatFormat > 100 || floatFormat < 0) {
    						return '公司业务力争权重必须是大于等于0小于等于100的整数';
    	...
    	editable: {
    		...
    		validate: function (v) {
    			...
    			if(val == '定性指标') {
    				...
    				if(v!=null&&v!=''){
    					if (isNaN(v)) {
    						return "零售业务力争权重必须是数字";
    					}
    					
    					
    					if (!pattern2.test(v)) {
    						return '零售业务力争权重必须是大于等于0小于等于100的整数';
    					}
    					var floatFormat = parseFloat(v);
    					if (floatFormat > 100 || floatFormat < 0) {
    						return '零售业务力争权重必须是大于等于0小于等于100的整数';
    	...
    	editable: {
    		...
    		validate: function (v) {
    			...
    			if(val == '定性指标') {
    				...
    				if(v!=null&&v!=''){
    					if (isNaN(v)) {
    						return "市场业务力争权重必须是数字";
    					}
    					
    					
    					if (!pattern2.test(v)) {
    						return '市场业务力争权重必须是大于等于0小于等于100的整数';
    					}
    					var floatFormat = parseFloat(v);
    					if (floatFormat > 100 || floatFormat < 0) {
    						return '市场业务力争权重必须是大于等于0小于等于100的整数';
    ...
    },
    {
        ...
        editable: {
            ...
            validate:function(v){
            	$el = $(this)[0]['$element'] === undefined?$(this):$(this)[0]['$element'];
            	var index = $el.parent().parent().index();
            	var indexLine = $("#datatable_q").bootstrapTable("getData")[index].indexLine;
            	if(indexLine!=undefined&&indexLine!=null){
                	if(indexLine=='01'){
                		//公司线
                		editableTableSetValue("datatable_q",index,"neguIndexWeiLS",null,"disable");
                		editableTableSetShowValue("datatable_q",index,"neguIndexWeiLS","--");
                		editableTableSetValue("datatable_q",index,"neguIndexWeiSC",null,"disable");
                		editableTableSetShowValue("datatable_q",index,"neguIndexWeiSC","--");
                		editableTableSetValue("datatable_q",index,"whfIndexWeiLS",null,"disable");
                		editableTableSetShowValue("datatable_q",index,"whfIndexWeiLS","--");
                		editableTableSetValue("datatable_q",index,"whfIndexWeiSC",null,"disable");
                		editableTableSetShowValue("datatable_q",index,"whfIndexWeiSC","--");
                		
                	}else if(indexLine=='02'){
                		//零售线
                		editableTableSetValue("datatable_q",index,"neguIndexWeiGS",null,"disable");
                		editableTableSetShowValue("datatable_q",index,"neguIndexWeiGS","--");
                		editableTableSetValue("datatable_q",index,"neguIndexWeiSC",null,"disable");
                		editableTableSetShowValue("datatable_q",index,"neguIndexWeiSC","--");
                		editableTableSetValue("datatable_q",index,"whfIndexWeiGS",null,"disable");
                		editableTableSetShowValue("datatable_q",index,"whfIndexWeiGS","--");
                		editableTableSetValue("datatable_q",index,"whfIndexWeiSC",null,"disable");
                		editableTableSetShowValue("datatable_q",index,"whfIndexWeiSC","--");
    ...
    },
    {
        ...
        editable: {
            ...
            validate:function(v){
            	$el = $(this)[0]['$element'] === undefined?$(this):$(this)[0]['$element'];
            	var index = $el.parent().parent().index();
            	var indexLine = $("#datatable_y").bootstrapTable("getData")[index].indexLine;
            	if(indexLine!=undefined&&indexLine!=null){
                	if(indexLine=='01'){
                		//公司线
                		editableTableSetValue("datatable_y",index,"neguIndexWeiLS",null,"disable");
                		editableTableSetShowValue("datatable_y",index,"neguIndexWeiLS","--");
                		editableTableSetValue("datatable_y",index,"neguIndexWeiSC",null,"disable");
                		editableTableSetShowValue("datatable_y",index,"neguIndexWeiSC","--");
                		editableTableSetValue("datatable_y",index,"whfIndexWeiLS",null,"disable");
                		editableTableSetShowValue("datatable_y",index,"whfIndexWeiLS","--");
                		editableTableSetValue("datatable_y",index,"whfIndexWeiSC",null,"disable");
                		editableTableSetShowValue("datatable_y",index,"whfIndexWeiSC","--");
                		
                	}else if(indexLine=='02'){
                		//零售线
                		editableTableSetValue("datatable_y",index,"neguIndexWeiGS",null,"disable");
                		editableTableSetShowValue("datatable_y",index,"neguIndexWeiGS","--");
                		editableTableSetValue("datatable_y",index,"neguIndexWeiSC",null,"disable");
                		editableTableSetShowValue("datatable_y",index,"neguIndexWeiSC","--");
                		editableTableSetValue("datatable_y",index,"whfIndexWeiGS",null,"disable");
                		editableTableSetShowValue("datatable_y",index,"whfIndexWeiGS","--");
                		editableTableSetValue("datatable_y",index,"whfIndexWeiSC",null,"disable");
                		editableTableSetShowValue("datatable_y",index,"whfIndexWeiSC","--");
...
function checkProfessionTypeNegu(item){
	if(isNull(item.neguIndexWeiZT)
			&&isNull(item.neguIndexWeiGS)
			&&isNull(item.neguIndexWeiLS)
			&&isNull(item.neguIndexWeiSC)
			){
		return false;
	}
	if((!isNull(item.neguIndexWeiGS)
			&&isNull(item.neguIndexWeiLS)
			&&isNull(item.neguIndexWeiSC))
			||
			(isNull(item.neguIndexWeiGS)
...
function checkProfessionTypeWhf(item){
	if(isNull(item.whfIndexWeiZT)
			&&isNull(item.whfIndexWeiGS)
			&&isNull(item.whfIndexWeiLS)
			&&isNull(item.whfIndexWeiSC)
			){
		return false;
	}
	if((!isNull(item.whfIndexWeiGS)
			&&isNull(item.whfIndexWeiLS)
			&&isNull(item.whfIndexWeiSC))
			||
			(isNull(item.whfIndexWeiGS)
...
function checkProfessionTypeNeguAndWhf(item){
	if(!isNull(item.neguIndexWeiGS)&&isNull(item.whfIndexWeiGS)&&(!isNull(item.whfIndexWeiLS)||!isNull(item.whfIndexWeiSC))) return false;
	if(!isNull(item.neguIndexWeiLS)&&isNull(item.whfIndexWeiLS)&&(!isNull(item.whfIndexWeiGS)||!isNull(item.whfIndexWeiSC))) return false;
	if(!isNull(item.neguIndexWeiSC)&&isNull(item.whfIndexWeiSC)&&(!isNull(item.whfIndexWeiLS)||!isNull(item.whfIndexWeiGS))) return false;
	return true;
}
function isNull(str){
	return str==null||str==='';
