            ...
            success:function (data) {
                ...
                if(numStr.indexOf(inNum)!=-1 && list.assIndexCateCd != '03'){
                    ...
                    if(tableIdQ == 'datatable_m' && list.assIndexCateCd == '03'){
                        ...
                        $("#"+tableIdQ +" tr[data-index = '" +indexQ+"'] a[data-name = 'neguIndexWei']").editable('toggleDisabled',false);
                        $("#"+tableIdQ+">tbody").find("tr").eq(indexQ).find("td").eq(10).find("a").text("--");
                        $("#"+tableIdQ +" tr[data-index = '" +indexQ+"'] a[data-name = 'whfIndexWei']").editable('toggleDisabled',false);
        ...
        editable: {
            ...
            validate:function(v){
                if(v!=undefined&&v!=null&&v=='定性指标'){
                    ...
                    disableSiblingsAndSetValue($el,'neguIndexWei','--');
                    disableSiblingsAndSetValue($el,'whfIndexWei','--');
        ...
        editable: {
            ...
            validate: function (v) {
                ...
                if(val == '定性指标') {
                    ...
                    if (!pattern2.test(v)) {
                        return '必保指标权重必须是大于等于0小于等于100的整数';
                    }
        ...
        editable: {
            ...
            validate: function (v) {
                ...
                if(val == '定性指标') {
                    ...
                    if (!pattern2.test(v)) {
                        return '力争指标权重必须是大于等于0小于等于100的整数';
                    }
                    var floatFormat = parseFloat(v);
                    if (floatFormat > 100 || floatFormat < 0) {
                        return '力争指标权重必须是大于等于0小于等于100的整数';
