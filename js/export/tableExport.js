          ...
          ForEachVisibleCell(this, 'th,td', rowIndex, $hrows.length,
                             function (cell, row, col) {
                               if ( cell !== null ) {
                                 ...
                                 trData += '<th style="background-color:rgb(192,192,192);font-size: 13px;font-weight: 700;"';
                                 ...
                                 if ( tdcolspan > 0 )
                                   ...
                                   colspanCount += parseInt($(cell).attr('colspan') == null?1:$(cell).attr('colspan'));  //标题
             ...
             //添加表头
              if(index==0){
                titleTr += '<tr><th style="background-color:rgb(192,192,192);font-size: 13px;font-weight: 700;" colspan="'+colspanCount+'" rowspan="1">'+titleName+'</th></tr>';
                docData += titleTr;
              }
          if ( trData.length > 0 )
